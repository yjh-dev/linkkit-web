            ...
            <div class="bg-white rounded-3xl shadow-2xl overflow-hidden">
                ...
                <div class="bg-gradient-to-br from-linkkit-blue to-blue-600 px-8 py-12 text-center">
                    ...
                    <div class="mb-6">
                        ...
                        @else
                            <div
                                class="w-32 h-32 mx-auto bg-white rounded-full flex items-center justify-center shadow-2xl ring-4 ring-white">
                                ...
                                <a href="{{ $link->url }}" target="_blank" rel="noopener noreferrer"
                                    ...
                                    <div class="flex items-center justify-between gap-4">
                                        <div class="flex-1 min-w-0 pr-4">
                                            <h3
                                                class="font-bold text-gray-800 text-lg mb-2 group-hover:text-linkkit-blue transition-colors">
                                                {{ $link->title }}
                                            </h3>
                                        ...
                                        <div class="flex-shrink-0">
                                            <svg class="w-6 h-6 text-gray-400 group-hover:text-linkkit-blue transition-colors"
                ...
                <div class="px-8 pb-10 pt-6 border-t border-gray-100">
                    <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                        ...
                        <a href="{{ route('linkpage.edit.form', $linkPage->uuid) }}"
                            class="flex items-center gap-2 px-6 py-3 bg-gray-800 hover:bg-gray-900 text-white rounded-xl transition-all font-medium shadow-md">
